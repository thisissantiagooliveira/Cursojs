...
$listaUsuario = $UsuarioRepositorio->listaUsuarios();

$contador =0;

$quant = $UsuarioRepositorio->contarTodosUsuarios();
?>

<h3>Lista de Superior</h3>
...
while ($contador < $quant){
    ...
    echo "<td>&nbsp;<a href='listaPorSuperior2.php?id=".$Usuario->getId().
