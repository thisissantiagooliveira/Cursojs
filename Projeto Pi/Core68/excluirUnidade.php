...
?>
<h3>APAGAR Unidade</h3>
<h5>ESSA UNIDADE SERA APAGADO PERMANENTEMENTE
PORÉM ANTES DISSO VOCÊ TEM QUE APAGAR TODOS OS VINCULOS
DESSA UNIDADE.</h5>
<form action="excluirUnidade2.php" method="get">

<label>Digite o nome do unidade:</label>
