...
$listaAtivo = $AtivoRepositorio->listarAtivoPorIdAmbienteDesbloqueado($id);

$contador =0;

$quant = $AtivoRepositorio->contarTodosAtivosPorIdAmbienteDesbloqueados($id); 
?>

<h3>Lista de Ativo por Ambiente</h3>
...
while ($contador < $quant){
    ...
    echo "<td>&nbsp;<a href='bloquearAtivo4.php?id=".$Ativo->getId().
                                    "'>".$Ativo->getNome()."</a>&nbsp;</td>";
 echo "</tr>";
...
<br/> 
<a href="bloquearAtivo2.php">Voltar</a>  
</body>
</html>   
<?php 
}
