...
<h3>Alterar o Unidade</h3>
<h5>Digite as informações da Unidade que deseja alterar.</h5>
<form action="alterarUnidade2.php" method="get">
<label>Digite o nome do usuario:</label>
<input type="text" name="nome" size="30"/><br/>
<h4>OU</h4>
<label>Digite o sigla do usuario:</label>
