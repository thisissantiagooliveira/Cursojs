...
<h3>Desbloqueio de Unidade</h3>
<h5>Digite as informações da Unidade que deseja Desbloquear.</h5>
<form action="desbloquearUnidade2.php" method="get">

<label>Digite o nome da Unidade:</label>
<input type="text" name="nome" size="30"/><br/>
<h4>OU</h4>
<label>Digite a sigla da Unidade:</label>
<input type="text" name="sigla" size="30"/><br/><br/>
