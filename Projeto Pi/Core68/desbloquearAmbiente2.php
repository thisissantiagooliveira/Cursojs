...
if ($nome != ""){
    $Ambiente = $AmbienteRepositorio->consultarAmbienteBloqueadoPorNome($Ambiente);
...
<h3>Bloquear o Ambiente </h3>
<form action="desbloquearAmbiente3.php" method="get">
<label>Nome: </label>
<input readonly type="text" name="nome" size="35" value="<?php echo $Ambiente->getNome(); ?>"><br/><br/>

<input type="hidden" name="situacao" value="<?php echo $Ambiente->getSituacao()?>" >
