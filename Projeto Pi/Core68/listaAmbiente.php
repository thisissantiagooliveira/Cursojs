...
$quant = $AmbienteRepositorio->contarAmbientes();

$listaAmbientes= $AmbienteRepositorio->listaAmbientes();
...
while($contador < $quant){
    ...
    $Ambiente = $listaAmbientes[$contador];
    ...
    echo "<td>&nbsp;".$Ambiente->getUsuario()."</a>&nbsp;</td>";
    echo "<td>&nbsp;".$Ambiente->getUnidade()."&nbsp;</td>";
