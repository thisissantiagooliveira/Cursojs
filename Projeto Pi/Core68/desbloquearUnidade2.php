...
if ($nome != ""){
    ...
    $Unidade = $UnidadeRepositorio->consultarUnidadeBloqueadoPorSigla($Unidade);
}
...
<h3>Desbloquear a Unidade do Sistema</h3>
<form action="desbloquearUnidade3.php" method="get">
<label>Nome: </label>
