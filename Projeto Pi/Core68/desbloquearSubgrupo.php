...
$quant = $GrupoRepositorio->contarGrupos();

$listaGrupos= $GrupoRepositorio->listaGrupos();
...
while($contador < $quant){
    ...
    echo "<tr ".$cor.">";
    echo "<td>&nbsp;<a href='desbloquearSubgrupo2.php?id=".$Grupo->getId().
    "'>".$Grupo->getNome()."</a>&nbsp;</td>";
