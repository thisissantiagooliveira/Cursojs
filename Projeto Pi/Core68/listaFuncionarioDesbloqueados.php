...
$quant = $FuncionarioRepositorio->contarTodosFuncionariosDesbloqueado();

$listaFuncionario= $FuncionarioRepositorio->listaFuncionariosDesbloqueados();


?> 
<h3>Lista de Funcionarios Desbloqueadas</h3>
...
while($contador < $quant){
    ...
    $Funcionario = $listaFuncionario[$contador];
