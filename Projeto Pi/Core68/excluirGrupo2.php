...
if ($id != ""){
    $Grupo = $GrupoRepositorio->consultaGrupoPorId($Grupo);
  ...
  <h3>Excluir Grupo Permanentemente</h3>
<form action="excluirGrupo3.php" method="get">

<label>Id: </label>
<input readonly type="text" name="id" size="35" value="<?php echo $Grupo->getId(); ?>"><br/><br/>
