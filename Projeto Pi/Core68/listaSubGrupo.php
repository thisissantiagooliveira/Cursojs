...
$quant = $SubGrupoRepositorio->contarSubGrupo();

$listaSubGrupos= $SubGrupoRepositorio->listaSubGrupos();
...
while($contador < $quant){
    ...
    $SubGrupo = $listaSubGrupos[$contador];
    ...
    echo "<td>&nbsp;".$SubGrupo->getGrupo()."</a>&nbsp;</td>";
