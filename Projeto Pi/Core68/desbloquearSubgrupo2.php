...
$listaSubGrupo = $SubGrupoRepositorio->listarSubGrupoPorIdGrupo($id);

$contador =0;

$quant = $SubGrupoRepositorio->contarTodosSubGrupoPorIdGrupo($id);
?>

<h3>Lista de SubGrupos por Grupos</h3>
...
while ($contador < $quant){
    ...
    echo "<tr>";
    echo "<td>&nbsp;".$SubGrupo->getId()."</td>";
    echo "<td>&nbsp;<a href='desbloquearSubgrupo3.php?id=".$SubGrupo->getId().
                                    "'>".$SubGrupo->getNome()."</a>&nbsp;</td>";
 echo "</tr>";
...
<br/> 
<a href="desbloquearSubgrupo3.php">Voltar</a>  
</body>
</html>   
<?php 
}
