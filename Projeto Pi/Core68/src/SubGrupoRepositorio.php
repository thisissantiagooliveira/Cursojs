...
class SubGrupoRepositorio
{
    ...
    public function CadastrarSubGrupo($SubGrupo) {
        ...
        $codigoSQL = "INSERT INTO SUBGRUPO(NOME,IDUSUARIO,IDGRUPO,SITUACAO)".
            " VALUES ('".$this->SubGrupo->getNome()."',".$this->SubGrupo->getUsuario()->getId().",".$this->SubGrupo->getGrupo()->getId().", 0)";
    ...
    public function  listaSubGrupos(){
        ...
        if($nLinha > 0){
            ...
            while($linha = mysqli_fetch_assoc($resultado)){
                ...
                $SubGrupo->setUsuario($linha['IDUSUARIO']);
                $SubGrupo->setGrupo($linha['IDGRUPO']);
    ...
    public function listarSubGrupoPorIdGrupo($idGrupo)
    {
        $listaSubGrupo = '';
        
        $codigoSQL = "SELECT * FROM SUBGRUPO WHERE IDGRUPO = " . $idGrupo . " ORDER BY NOME;";
        ...
        if ($numeroLinhas > 0) {
            ...
            while ($linha = mysqli_fetch_assoc($resultado)) {
                ...
                $listaSubGrupo[$contador] = $SubGrupo;
                $contador ++;
            }
        }
        $this->Conexao->fecharBanco();
    ...
    public function contarTodosSubGrupoPorIdGrupo($idGrupo){
        $quant = 0;
