...
if ($nome != ""){
    $Unidade = $UnidadeRepositorio->consultarUnidadeBloqueadoPorNome($Unidade);
}
else if ($sigla != ""){
    $Unidade = $UnidadeRepositorio->consultarUnidadeBloqueadoPorSigla($Usuario);
}
...
if($retorno == TRUE){
    echo "Esse Unidade foi Desbloqueado com sucesso";
}
else {
    echo "Falha no Desbloqueio da Unidade";
}
