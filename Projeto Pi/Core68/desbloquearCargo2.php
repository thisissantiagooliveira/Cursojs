...
if ($nome != ""){
    $Cargo = $CargoRepositorio->consultarCargoBloqueadoPorNome($Cargo);
}
...
<h3>Desbloquear o Cargo do Sistema</h3>
<form action="desbloquearCargo3.php" method="get">
<label>Nome: </label>
...
<input type="text" name="id" value="<?php echo $Cargo->getId()?>" >
