...
<h3>Desbloqueio do Ativo pelo Codigo de Barras</h3>
<h5>Digite o codigo do Ativo que deseja Desbloquear.</h5>
<form action="DesbloquearPorCodigoBarras2.php" method="get">
