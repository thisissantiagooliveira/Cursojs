...
$quant = $SubGrupoRepositorio->contarTodosSubGruposDesbloqueado();

$listaSubGrupo= $SubGrupoRepositorio->listaSubGruposDesbloqueados();

?> 
<h3>Lista de SubGrupo Bloqueadas</h3>
...
while($contador < $quant){
    ...
    echo "<td>&nbsp;".$SubGrupo->getNome()."&nbsp;</td>";
    echo "<td>&nbsp;".$SubGrupo->getUsuario()."</a>&nbsp;</td>";
