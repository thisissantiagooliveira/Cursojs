...
if ($Funcionario->getnome() == ""){
    ...
    echo "Funcionario não encontardo";
}
else{
    
    echo "ID:".$Funcionario->getId()."<br/>";
    echo "NOME: ".$Funcionario->getNome()."<br/>";
    echo "TURNO: ".$Funcionario->getTurno()."<br/>";
    echo "DATA: ".$Funcionario->getData()."<br/>";
    echo "IDUSUARIO: ".$Funcionario->getUsuario()."<br/>";
    echo "SUPERIOR: ".$Funcionario->getSuperior()."<br/>";
    echo "CARGO:".$Funcionario->getCargo()."<br/>";
    echo "UNIDADE: ".$Funcionario->getUnidade()."<br/>";
    echo "SITUACAO: ".$Funcionario->getSituacao()."<br/>";
