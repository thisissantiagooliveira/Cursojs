...
$listaUsuario = $UsuarioRepositorio->listaPorNivel($nivel);

$contador =0;

$quant = $UsuarioRepositorio->contarPorNivel($nivel);
?>

<h3>Lista de Usuarios por Nivel</h3>
...
while ($contador < $quant){
    ...
    echo "<td>&nbsp;<a href='infoNivel.php?id=".$Usuario->getId().
...
<br/> 
<a href="listaPorNIvel.php">Voltar</a>  
</body>
</html>   
<?php 
}
