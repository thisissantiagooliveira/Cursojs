...
$listaAmbiente = $AmbienteRepositorio->listarAtivoPorIdAmbiente($id);

$contador =0;

$quant = $AmbienteRepositorio->contarTodosAtivoPorIdAmbiente($id);
?>

<h3>Lista de Ativos por Ambiente</h3>
...
while ($contador < $quant){
    ...
    echo "<td>&nbsp;<a href='CadastrarMovimentacao.php?id=".$Ambiente->getId().
...
<br/> 
<a href="Movimentacao3.php">Voltar</a>  
</body>
</html>   
<?php 
}
