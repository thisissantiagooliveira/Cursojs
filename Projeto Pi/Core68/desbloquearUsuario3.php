...
if ($nome != ""){
    $Usuario = $UsuarioRepositorio->consultarUsuarioBloqueadoPorNome($Usuario);
}
else if ($login != ""){
    $Usuario = $UsuarioRepositorio->consultarUsuarioBloqueadoPorLogin($Usuario);
}
...
$UsuarioRepositorio = new UsuarioRepositorio();
$retorno = $UsuarioRepositorio->desbloquearUsuario($Usuario);

if($retorno == TRUE){
    echo "Esse Usuario foi Desbloqueado com sucesso";
}
else {
    echo "Falha no Desbloqueio do Usuario";
}
