...
<h3>Consulta das informações do Ativo</h3>
<form action="alterarAtivo4.php" method="get">
<label>ID: </label>
<input readonly type="text" name="id" size="25" value="<?php echo $Ativo->getId(); ?>"><br/><br/>

<label>Nome: </label>
<input readonly type="text" name="nome" size="25" value="<?php echo $Ativo->getNome(); ?>"><br/><br/>

<label>Data: </label>
<input  readonly  type="text" name="data" size="25" value="<?php echo $Ativo->getData(); ?>"><br/><br/>

<label>Descricao: </label>
<input readonly type="text" name="descricao" size="25" value="<?php echo $Ativo->getDescricao(); ?>"><br/><br/>

<label>Codigo de barras: </label>
<input readonly type="text" name="codigobarra" size="25" value="<?php echo $Ativo->getCodigobarra(); ?>"><br/><br/>

<label>Status:</label>
<select name="idStatus" disabled="disabled">
...
<label>Ambiente:</label><select name="idAmbiente" disabled="disabled">
...
<label>SubGrupo:</label><select name="idSugbrupo" disabled="disabled">
