...
$listaAmbiente = $AmbienteRepositorio->listarAmbientePorIdUnidade($id);

$contador =0;

$quant = $AmbienteRepositorio->contarTodosAmbientePorIdUnidade($id); 
?>
...
while ($contador < $quant){
    ...
    echo "<td>&nbsp;<a href='consultarAmbiente3.php?id=".$Ambiente->getId().
                                    "'>".$Ambiente->getNome()."</a>&nbsp;</td>";
 echo "</tr>";
...
<br/> 
<a href="consultarAmbiente3.php">Voltar</a>  
</body>
</html>   
<?php 
}
