...
$Ativo = $AtivoRepositorio->consultarAtivoBloqueadoPorId($Ativo);


?>


<h3>Desbloquear o Ativo</h3>
<form action="desbloquearAtivo5.php" method="get">
...
<option>Selecionar Status</option disabled="disabled">
