...
$listaAtivo = $AtivoRepositorio->listarAtivoPorIdAmbiente($id);

$contador =0;

$quant = $AtivoRepositorio->contarTodosAtivosPorIdAmbiente($id); 
?>
...
while ($contador < $quant){
    ...
    echo "<td>&nbsp;<a href='consultarAtivo4.php?id=".$Ativo->getId().
                                    "'>".$Ativo->getNome()."</a>&nbsp;</td>";
 echo "</tr>";
...
<br/> 
<a href="consultarAtivo2.php">Voltar</a>  
</body>
</html>   
<?php 
}
