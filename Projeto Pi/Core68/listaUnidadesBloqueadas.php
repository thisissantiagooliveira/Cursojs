...
$quant = $UnidadeRepositorio->contarTodasUnidadesBloqueada();

$listaUnidade= $UnidadeRepositorio->listaUnidadesBloqueadas();


?> 
<h3>Lista de Unidades Desbloqueadas</h3>
...
while($contador < $quant){
    ...
    echo "<td>&nbsp;".$Unidade->getUsuario()."</a>&nbsp;</td>";
